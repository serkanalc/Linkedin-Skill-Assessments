...
#### Q1. Which component is not an entry point through which the system or a user can enter your app?
...
#### Q2. What should you use to display a large, scrolling list of elements?
...
#### Q3. What is the correct set of component classes needed to implement a RecyclerView of items that displays a list of widgets vertically?
...
#### Q4. The Android system kills process when it needs to free up memory. The likelihood of the system killing a given process depends on the state of the process and the activity at the time. With combination of process and activity state is most likely to be killed?
...
#### Q5. You have created a NextActivity class that relies on a string containing some data that pass inside the intent Which code snippet allows you to launch your activity?
...
#### Q6. You want to include about and setting modules in your project. Which files accurately reflects their inclusion?
...
#### Q7. What is the benifit of using @VisibleForTesting annotation?
...
#### Q9. When will an activity's onActivityResult()be called?
...
#### Q10. You need to remove an Event based on it;s id from your API, Which code snippet defines that request in Retrofit?
...
#### Q11. When would you use a product flavour in your build setup?
...
#### Q12. Given the fragment below, how would you get access to a TextView with an ID of text_home contained in the layout file of a Fragment class?
...
#### Q13. Why do you use the AndroidJUnitRunner when running UI tests?
...
#### Q14. What allows you to properly restore a user's state when an activity is restarted?
...
#### Q15. Given the definition below. how would you get access a TextView with an ID of text_home contained in thr layout file of a Fragment class?
...
#### Q16. IF the main thread is blocked for too long, the system displays the \_ dialog?
...
#### Q17. How would you retrieve the value of a user's email from SharedPreferences while ensuring that the returned value is not null?
...
#### Q18. Why is it problematic to define sizes using pixels on Android?
...
#### Q19. You need to get a list of devices that are attached to your computer with USB debugging enable. Which command would execute using the Android Debug Bridge?
...
![shape](https://user-images.githubusercontent.com/70329389/148702545-09e49301-1350-401d-90e4-2cd1885b7d1e.png)
...
#### Q21. To persist a small collection of key-value data, what should you use?
...
#### Q24. What tag should you use to add a reusable view component to a layout file?
...
- [ ] A
      ![00](https://user-images.githubusercontent.com/70329389/148702555-9cd5bc7c-e5f3-4780-8e18-6a0a609bb697.jpeg)
- [x] B
      ![01](https://user-images.githubusercontent.com/70329389/148702562-2fcce484-59e5-4fbf-bb43-82d2a393bb74.jpeg)
- [ ] C
      ![02](https://user-images.githubusercontent.com/70329389/148702573-7b0fcdc6-f753-4788-a21a-f1904c35375c.jpeg)
- [ ] D
      ![03](https://user-images.githubusercontent.com/70329389/148702582-851da52e-8319-4c99-bf83-69b030d1ebe7.jpeg)
...
![04](https://user-images.githubusercontent.com/70329389/148702528-cc4196c8-9b79-4305-8bf9-a3fa1afa58d9.jpeg)
...
#### Q41. You need to upgrade to the latest version of the Android Gradle plugin. Which file should you modify?
...
#### Q42. Why do developers often put app initialization code in the Application class?
...
#### Q43. What folder should you use for your app's launcher icons?
...
![43](https://user-images.githubusercontent.com/70329389/148702596-f5bf291b-f92b-4dcb-82d4-544ec27696f3.jpeg)
...
![44](https://user-images.githubusercontent.com/70329389/148702629-4a4c58b3-d466-4d04-8d83-07ceab64397d.jpeg)
...
#### Q46. Given this code snippey from a build.gradle file, which choice is not a possible build variant?
...
#### Q48. To add features, components, and permissions to your Android app, which file needs to be edited?
...
#### Q49. Which XML attribute should be used to make an Image View accessible?
...
#### Q50. You launch your app, and when you navigate to a new screen it crashes, Which action will NOT help you diagnose the issue?
...
#### Q51. Why might push notifications stop working?
...
#### Q63. You want to open the default Dialer app on a device. What is wrong with this code?
...
#### Q64. When should you store files in the `/assets` directory?
...
#### Q65. You want to allow users to take pictures in your app. Which is _not_ an advantage of creating an appropriate `intent`, instead of requesting the camera permission directly?
...
#### Q66. When would you use the `ActivityCompat.shouldShowRequestPermissionRationale()` function?
...
#### Q66. Which approach is not recommended for providing a useful offline state in your app?
